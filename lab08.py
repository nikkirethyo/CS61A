...
class Person(object):
    ...
    'Would you please preserve abstraction barriers'
    """
    stuff = "I squirreled it away before it could catch on fire."
...
class CheckingAccount(Account):
    ...
    def deposit_check(self, check):
        ...
        elif check.deposited or check.payable_to != self.holder: 
...
#         total = ''
#         for items in typing_input: 
#             total += self.buttons[items]
#         return total
