...
def starts_with(lst, sublst):
    ...
    if sublst == empty:
        ...
        return False    
    elif first(sublst) != first(lst):
        return False 
    else:   
        return starts_with(rest(lst), rest(sublst))
...
def has_sublist(lst, sublst):
    ...
    if sublst == empty:
        ...
        return False 
    elif first(lst) == first(sublst):
        return starts_with(lst, sublst)
    else: 
        return has_sublist(rest(lst), sublst)
